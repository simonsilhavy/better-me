...
export const RETRO_QUESTIONS: RetroQuestion[] = [
  ...
  { id: 'jinak', text: 'Co bys udělal jinak, pokud by jsi zažil dnešek znovu?' },
  ...
  { id: 'zmenit-jednu', text: 'Pokud by si mohl na dnešku změnit jednu věc, co by to bylo?' },
  ...
  { id: 'obetoval', text: 'Co si dnes obětoval pro svůj vysněný život?' },
